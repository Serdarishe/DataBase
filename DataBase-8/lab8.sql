...
ALTER TABLE employees DROP CONSTRAINT IF EXISTS employees_dept_email_key;
ALTER TABLE employees ADD CONSTRAINT employees_dept_email_key UNIQUE (dept_id, email);

-- 14
DROP INDEX IF EXISTS emp_dept_salary_idx;
CREATE INDEX emp_dept_cover_idx ON employees(dept_id, salary DESC) INCLUDE (emp_name);
